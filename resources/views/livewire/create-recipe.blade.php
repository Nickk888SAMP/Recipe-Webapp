<div class="mt-4">
    <form wire:submit="save">
        ...
        <div class="mt-4">
            ...
            <ul wire:sortable="updateOrder" class="mt-4 flex flex-col gap-2">
                @foreach ($ingredients as $index => $value)
                        
                    <li wire:sortable.item="{{$index}}" class="flex justify-between items-center">
                        ...
                        <x-inputfield wire:model="ingredients.{{$index}}.amount" class="w-full h-10" type="number"/>
