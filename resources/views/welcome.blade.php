...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        {{-- Navbar --}}
        <nav x-data="{ hamburgerOpen: false }" class="relative container mx-auto p-6">
            {{-- Flex container --}}
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex space-x-6">
                    ...
                    <a href="#" class="hover:text-darkGrayishBlue">Carreers</a>
                ...
                {{-- Hamburger Icon --}}
                <button x-on:click="hamburgerOpen = !hamburgerOpen" x-bind:class="hamburgerOpen ? 'open' : ''" id="menu-btn" class="block hamburger md:hidden focus:outline-none">
            ...
            {{-- Mobile Menu --}}
            <div class="md:hidden">
                <div x-show="hamburgerOpen" x-transition id="menu" class="absolute flex flex-col items-center self-end py-8 mt-10 space-y-6 font-bold bg-white sm:w-auto sm:self-center left-6 right-6 drop-shadow-md">
                    <a href="#">Pricing</a>
                    <a href="#">Product</a>
                    <a href="#">About Us</a>
                    <a href="#">Careers</a>
                ...
                <div class="flex flex-col mt-24 md:flex-row md:space-x-6">
                    ...
                    <div class="flex flex-col items-center p-6 space-y-6 rounded-lg bg-veryLightGray md:w-1/3">
                        ...
                        <p class="text-sm text-darkGrayishBlue">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore libero eius perspiciatis magnam labore voluptate fuga veritatis facere, dignissimos blanditiis neque adipisci soluta ipsam cum molestiae voluptatibus ex? Assumenda, temporibus.
                        </p>
                    </div>
            ...
            <div class="container flex flex-col-reverse justify-between px-6 py-10 mx-auto space-y-8 md:flex-row md:space-y-0">
                ...
                <div class="flex flex-col-reverse items-center justify-between space-y-12 md:flex-col md:space-y-0 md:items-start">
                    ...
                    <div class="flex justify-center space-x-4">
                        {{-- Link 1 --}}
                        <a href="#">
                            <img src="{{ asset('img/icon-facebook.svg') }}" alt="" class="h-8">
                        </a>
                        {{-- Link 2 --}}
                        <a href="#">
                            <img src="{{ asset('img/icon-youtube.svg') }}" alt="" class="h-8">
                        </a>
                        {{-- Link 3 --}}
                        <a href="#">
                            <img src="{{ asset('img/icon-twitter.svg') }}" alt="" class="h-8">
                        </a>
                        {{-- Link 4 --}}
                        <a href="#">
                            <img src="{{ asset('img/icon-pinterest.svg') }}" alt="" class="h-8">
                        </a>
                        {{-- Link 5 --}}
                        <a href="#">
                            <img src="{{ asset('img/icon-instagram.svg') }}" alt="" class="h-8">
                        </a>
                    </div>
                </div>
